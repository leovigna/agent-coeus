 ...
 * ```
 */
export async function getEpisodes(provider: ZepClientProvider, params: z.objectOutputType<typeof getEpisodesInputSchema, ZodTypeAny>, { authInfo }: { authInfo: AuthInfo }): Promise<Zep.EpisodeResponse> {
...
export const createGetEpisodesProcedure = toProcedurePluginFn(getEpisodesInputSchema, getEpisodes, getEpisodesProcedureMetadata);
