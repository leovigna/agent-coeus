 ...
 */
export async function onboardUser(clients: { logToClient: LogToClient; zepClientProvider: ZepClientProvider }, _: void, { authInfo }: { authInfo: AuthInfo }) {
...
export const onboardUserMetadata = {
    ...
    config: {
        title: "Onboard",
        description: "Setup user account and create personal organization and default graph if not already present",
