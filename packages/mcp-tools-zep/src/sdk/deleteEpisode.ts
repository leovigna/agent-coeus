 ...
 * ```
 */
export async function deleteEpisode(provider: ZepClientProvider, params: z.objectOutputType<typeof deleteEpisodeInputSchema, z.ZodTypeAny>, { authInfo }: { authInfo: AuthInfo }): Promise<Zep.SuccessResponse> {
