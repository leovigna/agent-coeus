...
export interface RevealExtendedOptions extends Reveal.Options {
    // Can be used to initialize reveal.js in one of the following views:
    // - print:   Render the presentation so that it can be printed to PDF
    // - scroll:  Show the presentation as a tall scrollable page with scroll
    //            triggered animations
...
export interface RevealSlidesProps extends RevealExtendedOptions {
...
export const RevealSlides = ({ ref, presState = { indexh: -1, indexv: -1, indexf: -1, paused: false, overview: false }, disable = false, transitionOnThemeLoaded = "opacity 500ms ease-in-out", onStateChange, children, ...configProps }: RevealSlidesProps & { ref?: React.RefObject<RevealHandle | null> }) => {
